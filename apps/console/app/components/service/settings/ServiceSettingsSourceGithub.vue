	...
	<section class="flex flex-col gap-5">
		<div>
			...
			<p class="text-xs text-muted-foreground">
				A GitHub repository deployed through the connected GitHub App. Change the branch or build here; to move to a different repository, recreate
				the service.
			</p>
		</div>
	...
	<section class="flex flex-col gap-3">
		<div class="flex items-start justify-between gap-2">
			<div>
				...
				<p class="text-xs text-muted-foreground">
					Deploy automatically when a new commit lands — instantly via the App webhook, with polling as a fallback.
				</p>
			</div>
